...
export interface PluginRunController {
    ...
    send(input: string | UserMessagePart[]): Promise<{
        thinkingText: string;
...
export type PluginControllerFor<Capabilities extends PluginControllerCapabilities = never> = PluginRunController & ("models" extends Capabilities ? PluginModelController : {}) & ("sessions" extends Capabilities ? PluginSessionController : {});
...
export interface PluginSessionRuntimeBase {
    submit(input: string | UserMessagePart[] | InputEvent): Promise<{
        runId: string;
    }>;
...
export type PluginSessionRuntime<Capabilities extends PluginControllerCapabilities = never> = PluginSessionRuntimeBase & ("models" extends Capabilities ? PluginModelController : {}) & ("sessions" extends Capabilities ? PluginSessionController : {});
